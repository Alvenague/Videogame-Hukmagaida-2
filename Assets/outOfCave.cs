...
public class outOfCave : MonoBehaviour {
	...
	void OnTriggerEnter(Collider other) {
		...
		if (firstTime) {
			...
			missionTxt.guiText.text = "Finally I am out of the cave.\nAnd it looks like I am at the other side of the mountain too! \nIf I remember correctly Whitemoor should be in this direction!";
